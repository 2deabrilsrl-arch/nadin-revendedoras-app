...
export const metadata: Metadata = {
  title: 'Nadin Lenceria - Revendedoras',
  description: 'App para revendedoras de Nadin Lenceria. Gestiona tus pedidos, catalogo y ventas de forma profesional.',
  applicationName: 'Nadin Revendedoras',
  authors: [{ name: 'Nadin Lenceria' }],
  generator: 'Next.js',
  keywords: [
    'nadin',
    'lenceria',
  ...
  creator: 'Nadin Lenceria',
  publisher: 'Nadin Lenceria',
  robots: {
    index: false,
    follow: false,
  },
  ...
  openGraph: {
    ...
    title: 'Nadin Lenceria - Revendedoras',
    description: 'App para revendedoras de Nadin Lenceria',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
